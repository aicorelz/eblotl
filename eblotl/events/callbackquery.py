...
class CallbackQuery(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        async def respond(self, *args, **kwargs):
            ...
            `eblotl.client.messages.MessageMethods.send_message` with
            ``entity`` already set.
        ...
        async def edit(self, *args, **kwargs):
            ...
            `eblotl.client.messages.MessageMethods.edit_message` with
            ...
            .. note::
                ...
                `Message.edit <eblotl.tl.custom.message.Message.edit>`,
