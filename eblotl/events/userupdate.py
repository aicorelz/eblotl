...
class UserUpdate(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        @property
        def user(self):
            """Alias for `sender <eblotl.tl.custom.sendergetter.SenderGetter.sender>`."""
            return self.sender

        async def get_user(self):
            """Alias for `get_sender <eblotl.tl.custom.sendergetter.SenderGetter.get_sender>`."""
            return await self.get_sender()

        @property
        def input_user(self):
            """Alias for `input_sender <eblotl.tl.custom.sendergetter.SenderGetter.input_sender>`."""
            return self.input_sender

        async def get_input_user(self):
            """Alias for `get_input_sender <eblotl.tl.custom.sendergetter.SenderGetter.get_input_sender>`."""
            return await self.get_input_sender()

        @property
        def user_id(self):
            """Alias for `sender_id <eblotl.tl.custom.sendergetter.SenderGetter.sender_id>`."""
