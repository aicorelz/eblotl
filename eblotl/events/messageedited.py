...
class MessageEdited(NewMessage):
    ...
    <eblotl.events.newmessage.NewMessage>`, you should treat
    this event as a `Message <eblotl.tl.custom.message.Message>`.

    .. warning::

        On channels, `Message.out <eblotl.tl.custom.message.Message>`
