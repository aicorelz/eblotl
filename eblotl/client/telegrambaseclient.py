...
class TelegramBaseClient(abc.ABC):
    ...
    Arguments
        session (`str` | `eblotl.sessions.abstract.Session`, `None`):
        ...
        connection (`eblotl.network.connection.common.Connection`, optional):
            The connection instance to be used when creating a new connection
            to the servers. It **must** be a type.

            Defaults to `eblotl.network.connection.tcpfull.ConnectionTcpFull`.
        ...
        app_version (`str`, optional):
            ...
            Defaults to `eblotl.version.__version__`.
    ...
    def __init__(
        ...
        if not api_id or not api_hash:
            raise ValueError(
                ...
                "Refer to eblotl.rtfd.io for more information.")
    ...
    async def connect(self: 'TelegramClient') -> None:
        ...
        .. note::
            ...
            request, like `client.get_me() <eblotl.client.users.UserMethods.get_me>`,
        ...
        await self.session.set_auth_key(
            self._sender.auth_key
        )
    ...
    def __call__(self: 'TelegramClient', request, ordered=False):
        ...
        Args:
            ...
            flood_sleep_threshold (`int` | `None`, optional):
                ...
                `client.flood_sleep_threshold <eblotl.client.telegrambaseclient.TelegramBaseClient.flood_sleep_threshold>`
