...
class DialogMethods:
    ...
    def iter_dialogs(
        ...
        Yields
            Instances of `Dialog <eblotl.tl.custom.dialog.Dialog>`.
    ...
    def iter_drafts(
        ...
        Yields
            Instances of `Draft <eblotl.tl.custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <eblotl.tl.custom.dialog.Dialog.delete>`.
    ...
    def conversation(
        ...
        """
        Creates a `Conversation <eblotl.tl.custom.conversation.Conversation>`
        ...
        Arguments
            ...
            replies_are_responses (`bool`, optional):
                ...
                <eblotl.tl.custom.conversation.Conversation.get_response>`
                and a subsequent call to `conv.get_reply
                <eblotl.tl.custom.conversation.Conversation.get_reply>`
        ...
        Returns
            A `Conversation <eblotl.tl.custom.conversation.Conversation>`.
