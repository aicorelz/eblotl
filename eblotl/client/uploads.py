...
class UploadMethods:
    ...
    async def send_file(
        ...
        Arguments
            ...
            reply_to (`int` | `Message <eblotl.tl.custom.message.Message>`):
        ...
        Returns
            The `Message <eblotl.tl.custom.message.Message>` (or messages)
    ...
    async def upload_file(
        ...
        Returns
            ...
            `InputSizedFile <eblotl.tl.custom.inputsizedfile.InputSizedFile>`
