...
class DownloadMethods:
    ...
    async def download_media(
        ...
        See also `Message.download_media() <eblotl.tl.custom.message.Message.download_media>`.

        Arguments
            message (`Message <eblotl.tl.custom.message.Message>` | :tl:`Media`):
    ...
    async def download_file(
        ...
        Arguments
            input_location (:tl:`InputFileLocation`):
                ...
                See `eblotl.utils.get_input_location` source for a complete
