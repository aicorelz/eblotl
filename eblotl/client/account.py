...
class AccountMethods:
    def takeout(
        ...
        """
        Returns a :ref:`eblotl-client` which calls methods behind a takeout session.
        ...
        <eblotl.client.messages.MessageMethods.iter_messages>`.
        ...
        <eblotl.sessions.abstract.Session.takeout_id>`.
