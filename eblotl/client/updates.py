...
class UpdateMethods:
    ...
    def run_until_disconnected(self: 'TelegramClient'):
        ...
        <eblotl.client.telegrambaseclient.TelegramBaseClient.disconnect>`
    ...
    def add_event_handler(
        ...
        Arguments
            callback (`callable`):
                ...
                Note that if you have used `eblotl.events.register` in
            ...
            event (`_EventBuilder` | `type`, optional):
                ...
                If left unspecified, `eblotl.events.raw.Raw` (the
