...
class MessageButton:
    ...
    .. note::
        ...
        <eblotl.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `eblotl.client.telegramclient.TelegramClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None):
        ...
        sent, and the sent `Message <eblotl.tl.custom.message.Message>` returned.
