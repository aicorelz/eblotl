...
class InlineBuilder:
    ...
    <eblotl.events.inlinequery.InlineQuery>` ``results``.
    ...
    explained here to avoid repetition:
        ...
        buttons (`list`, `custom.Button <eblotl.tl.custom.button.Button>`, :tl:`KeyboardButton`, optional):
    ...
    async def photo(
        ...
        Args:
            ...
            file (`obj`, optional):
                ...
                <eblotl.client.uploads.UploadMethods.send_file>`.
