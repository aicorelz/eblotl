...
class Conversation(ChatGetter):
    ...
    async def send_message(self, *args, **kwargs):
        ...
        for `eblotl.client.messages.MessageMethods.send_message` with
        ``entity`` already set.
        """
    ...
    async def send_file(self, *args, **kwargs):
        ...
        for `eblotl.client.uploads.UploadMethods.send_file` with
        ``entity`` already set.
        """
    ...
    def get_response(self, message=None, *, timeout=None):
        ...
        Args:
            message (`Message <eblotl.tl.custom.message.Message>` | `int`, optional):
