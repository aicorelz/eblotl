...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <eblotl.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <eblotl.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.EntityLike`):
                ...
                .. note::
                    ...
                    <eblotl.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None):
        ...
        <eblotl.events.newmessage.NewMessage>`. You cannot distinguish
