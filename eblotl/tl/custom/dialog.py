...
class Dialog:
    ...
    Args:
        ...
        message (`Message <eblotl.tl.custom.message.Message>`):
        ...
        draft (`Draft <eblotl.tl.custom.draft.Draft>`):
    ...
    async def delete(self, revoke=False):
        ...
        Shorthand for `eblotl.client.dialogs.DialogMethods.delete_dialog`
