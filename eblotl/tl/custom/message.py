...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <eblotl.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <eblotl.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <eblotl.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `TelegramClient <eblotl.client.telegramclient.TelegramClient>`
    ...
    def forward(self):
        """
        The `Forward <eblotl.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <eblotl.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <eblotl.tl.custom.file.File>` wrapping the
        ...
        `file.id <eblotl.tl.custom.file.File.id>`,
        `file.name <eblotl.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from eblotl.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def respond(self, *args, **kwargs):
        ...
        `eblotl.client.messages.MessageMethods.send_message`
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `eblotl.client.messages.MessageMethods.forward_messages`
        ...
        `eblotl.client.telegramclient.TelegramClient` instance directly.
        """
        if self._client:
    ...
    async def edit(self, *args, **kwargs):
        ...
        `eblotl.client.messages.MessageMethods.edit_message`
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `eblotl.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `eblotl.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <eblotl.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <eblotl.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <eblotl.tl.types.PollAnswer>` argument.
    ...
    async def mark_read(self):
        ...
        <eblotl.client.messages.MessageMethods.send_read_acknowledge>`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
    ...
    async def pin(self, *, notify=False, pm_oneside=False):
        ...
        `eblotl.client.messages.MessageMethods.pin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def unpin(self):
        ...
        `eblotl.client.messages.MessageMethods.unpin_message`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
