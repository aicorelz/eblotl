            ...
            if tlobject.is_function:
                ...
                if tlobject.friendly:
                    ...
                    docs.write_text(
                        ...
                        '#eblotl.client.{0}.{1}"><code>client.{1}()</code></a> '
                ...
                docs.write('''<pre>\
<strong>from</strong> eblotl.sync <strong>import</strong> TelegramClient
<strong>from</strong> eblotl <strong>import</strong> functions, types
